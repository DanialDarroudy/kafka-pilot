package at.uibk.dps.coordinator.module.broker.configuration.apply.business;

import at.uibk.dps.coordinator.module.broker.configuration.apply.abstraction.IBrokerConfigApplier;
...
public class BrokerConfigApplier implements IBrokerConfigApplier {
    ...
    public void apply(String brokerId, ApplyBrokerConfigRequestDto dto) {
        try {
            var resource = new ConfigResource(ConfigResource.Type.BROKER, brokerId);
