package at.uibk.dps.coordinator.core.observability.di;

import at.uibk.dps.coordinator.core.observability.config.ObservabilityConfig;
...
public class ObservabilityDependencyInstaller {
    ...
    public Meter getMeter() {
        ...
        return provider.get("ProducerMeter");
    }
    ...
    public Logger getLogger() {
        ...
        return provider.get("ProducerLogger");
    }
